...
export type OrderPickupReadyEmailProps = {
  order: OrderEmailOrder
}

const BRAND_URL = "https://teherguminet.hu"
const PICKUP_ADDRESS = "2884, Bakonyszombathely Bem utca 36."
const PICKUP_PHONE_DISPLAY = "+36 30 204 0053"
const PICKUP_PHONE_LINK = "+36302040053"
const PICKUP_EMAIL = "info@teherguminet.hu"
const FONT_STACK =
...
export const mockOrderPickupReady: OrderPickupReadyEmailProps = {
  order: {
...
export default () => <OrderPickupReadyEmail {...mockOrderPickupReady} />
